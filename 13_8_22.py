...
class burger(item):
    def __init__(self, name, meat, price):
        super().__init__(name, price)
        self.meat = meat
    
    def variation(description):
        desc = str(description)

beef_desc = 'Angus beef patty with lettuce and ketchup'
beef = burger('Burger', 'Beef', 5)
beef.variation(beef_desc)
print(beef.variation)
